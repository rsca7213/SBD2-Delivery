...
--DDL
GRANT CREATE ANY TABLE, ALTER ANY TABLE, DROP ANY TABLE TO administrador;
GRANT CREATE ANY TRIGGER, DROP ANY TRIGGER TO administrador;
GRANT CREATE ANY PROCEDURE TO administrador;
GRANT CREATE USER, CREATE ROLE TO administrador;
GRANT CREATE ANY VIEW, DROP ANY VIEW TO administrador;
GRANT CREATE SESSION TO administrador;
GRANT CREATE ANY SEQUENCE, DROP ANY SEQUENCE TO administrador;
GRANT CREATE ANY TYPE, DROP ANY TYPE TO administrador;
GRANT CREATE ANY DIRECTORY, DROP ANY DIRECTORY TO administrador;
GRANT GRANT ANY PRIVILEGE TO administrador;
GRANT ALTER DATABASE TO administrador;

...
BEGIN
    ...
    (CASE WHEN c.descuento<100 THEN '$' || TO_CHAR((s.precio-s.precio*(c.descuento/100))*ROUND(MONTHS_BETWEEN(c.rango_fechas.fecha_fin,c.rango_fechas.fecha_inicio))) ELSE 'Exento de pago' END || ' ' ||

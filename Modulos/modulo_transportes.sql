    ...
    BEGIN
        ...
        LOOP
            ...
            LOOP
                ...
                --Ciclo para determinar la zona de ubicación del transporte

                SELECT COUNT(*) INTO cantidad_zonas_proveedor
                FROM zonas_proveedores zp
                WHERE proveedor.ID=zp.ID_PROVEEDOR;

                zona_transporte := CEIL(DBMS_RANDOM.VALUE(0,cantidad_zonas_proveedor));
